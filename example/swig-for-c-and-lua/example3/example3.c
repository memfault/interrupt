...
void callProcessStruct(lua_State *L, my_struct_t *my_struct, uint32_t prioritiesCount)
{
...
int main(void)
{
    ...
    int r = luaL_loadfile(L, "example3.lua");
    assert(r == LUA_OK);
    ...
    callProcessStruct(L, &my_struct, prioritiesCount);
