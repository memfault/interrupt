...
One build is larger than the other, and it looks like most of that difference comes from the `.data` section.
...
Iteresting. We are loading the value of 100 into register r0 instead of 1 in the other build.
