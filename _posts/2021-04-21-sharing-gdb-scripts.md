...
in [a few posts](/tag/zero-to-main). This post is about how to share custom
commands easily with your team.
...
Python instead, you should check out my previous post on wrapping
[GDB with Invoke](/blog/building-a-cli-for-firmware-projects).
...
<p align="center">
  <img width="600" src="/img/sharing-gdb-scripts/eclipse-debug-configuration.png" />
</p>
