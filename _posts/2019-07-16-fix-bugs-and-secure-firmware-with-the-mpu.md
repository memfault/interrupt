...
from using the _eXecute Never capability_ (`XN`). In a
[previous article](/blog/how-to-write-linker-scripts-for-firmware#section-definitions),
...
dynamically determine at runtime or via a
[GDB Python script](/blog/automate-debugging-with-gdb-python-api) whether or not
an MPU is present and use it. The **only** field of interest here is `DREGION`
which reveals the number of MPU regions which were implemented. A value of 0 for
`DREGION` indicates the MPU was not implemented.
...
some
[function attributes](https://gcc.gnu.org/onlinedocs/gcc-12.2.0/gcc/Common-Function-Attributes.html#Common-Function-Attributes)
and
[binary constants](https://gcc.gnu.org/onlinedocs/gcc-12.2.0/gcc/Binary-constants.html)
...
The NRF52 SDK defines a
[linker script variable](/blog/how-to-write-linker-scripts-for-firmware#variables),
