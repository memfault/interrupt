...
as specified in the
[linker script](/blog/how-to-write-linker-scripts-for-firmware) (stored in Flash
and not copied in RAM as it is constant). I can find it under that line:
...
with options to sort symbols by size,
[check out this article from François](/blog/best-firmware-size-tools).
