...
[Firmware Code Size Optimization](/tag/fw-code-size) series.
[Last time](/blog/best-firmware-size-tools), we talked about measuring code size
as a precondition to improving it. Now we’ll leap from planning into action!
...
> dropping vector tables even when the KEEP command is used. You can find more
...
[^2]:
    [GCC Optimize Options](https://gcc.gnu.org/onlinedocs/gcc-12.2.0/gcc/Optimize-Options.html)
