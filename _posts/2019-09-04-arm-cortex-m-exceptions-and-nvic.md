...
- **Reset** - This is the routine executed when a chip comes out of reset. More
  ...
  [Zero to main() series of posts](/tag/zero-to-main).
...
{: #exception-number-diagram} ![](/img/armv-m-exceptions/exception-numbers.png)
...
[^1]: [MPU overview](/blog/fix-bugs-and-secure-firmware-with-the-mpu)
