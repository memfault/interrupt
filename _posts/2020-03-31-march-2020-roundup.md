...
- [Oxidize 1K YouTube Replay](https://www.youtube.com/watch?v=zPuELAzJyno&feature=youtu.be)  
  The
  entire set of talks from the online Oxidize Embedded Rust conference that took
  place on March 20th, 2020.
...
- [Unleashing Mayhem over Bluetooth Low Energy](https://asset-group.github.io/disclosures/sweyntooth/)  
  A
  deep dive analysis into BLE vulnerabilities in popular BLE chipsets from
...
- [PlatformIO x Renode Demo - Zephyr Build and Debug on SiFive FE310](https://www.youtube.com/watch?v=EdC3kFZxSzI&feature=emb_logo)  
  This
  demo has every technical buzzword that people are excited about. PlatformIO,
  Renode, Zephyr, RISC-V, SiFive...
...
- [ARM GCC Inline Assembler Cookbook](http://www.ethernut.de/en/documents/arm-inline-asm.html)  
  Though
  this one isn't new, we stumbled upon it recently. Great reference on using
  inline assembly.
