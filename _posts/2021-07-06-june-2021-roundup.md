...
- [Reverse engineering and fixing a bug in the firmware of a "ThinkPad Compact USB Keyboard with TrackPoint" | Magic Smoke](https://hohlerde.org/rauch/en/elektronik/projekte/tpkbd-fix/) by Dennis Schneider<br>
  I love this so much. Dennis was frustrated by a hardware quirk on his Lenovo keyboard which triggered a click at an inappropriate time while scrolling. His solution? Dump the firmware, print out and understand the assembly, modify the firmware, and load it. Problem solved!
