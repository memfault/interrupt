...
executing as privileged. For example, unprivileged code may not access NVIC
...
{: #fpu-config-options} ![](/img/context-switching/cpacr-reg-layout.png)
...
In our [guide](/blog/arm-cortex-m-exceptions-and-nvic#exception-entry--exit)
...
[ARM Cortex-M Exception](/blog/arm-cortex-m-exceptions-and-nvic#built-in-exceptions)
...
1. Set up a build system and startup sequence for your MCU. Extensive details
   about what these steps look like can be found in our
   [zero to main() series](/tag/zero-to-main).
...
[^15]:
    [Extended Asm](https://gcc.gnu.org/onlinedocs/gcc-12.2.0/gcc/Extended-Asm.html)
