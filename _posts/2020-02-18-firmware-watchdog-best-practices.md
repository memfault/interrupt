...
[lessons learned from our post](/blog/cortex-m-hardfault-debug) about debugging
Cortex-M faults to this situation as well!
...
into the GDB Python API check out
[this post](/blog/automate-debugging-with-gdb-python-api)).
...
> NOTE: For more info about ARM exceptions in general, check out
> [our post here](/blog/arm-cortex-m-exceptions-and-nvic)
...
[^8]:
    [GCC Atomic Builtins](https://gcc.gnu.org/onlinedocs/gcc-12.2.0/gcc/_005f_005fatomic-Builtins.html)
