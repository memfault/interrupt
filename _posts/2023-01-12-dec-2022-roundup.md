...
An implementation of a delta-update system similar in application to zsync and casync but with some interesting design choices that seem quite nice! - Noah
