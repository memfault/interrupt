...
[Previously](/blog/gdb-for-firmware-1) we discussed how a significant portion of
developer time is spent _debugging_ firmware and how GDB can be a powerful
utility for this. In this article we will discuss how to become more efficient
at debugging by leveraging GDB's
...
these can even be used to reduce [code size](/blog/best-firmware-size-tools) by
replacing a on-device CLI command that would display the same information!
...
[Using Python PyPi Packages with GDB](/blog/using-pypi-packages-with-GDB)
